...
public class CroscuttingPCHException extends RuntimeException {

	private static final long serialVersionUID = -5855680087714145843L;
	protected String mensajeUsuario;
	protected Lugar lugar;

	public CroscuttingPCHException(String mensajeTecnico, String mensajeUsuario, Lugar lugar, Throwable exeptionRaiz) {
		super(mensajeTecnico, exeptionRaiz);
		setMensajeUsuario(mensajeUsuario);
		setLugar(lugar);
	}
	
	public CroscuttingPCHException(final String mensajeUsuario, final Lugar lugar) {
