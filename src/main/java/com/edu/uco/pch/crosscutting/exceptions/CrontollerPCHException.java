...
public class CrontollerPCHException extends RuntimeException {

	private static final long serialVersionUID = -5855680087714145843L;
	protected String mensajeUsuario;
	protected Lugar lugar;

	public CrontollerPCHException(String mensajeTecnico, String mensajeUsuario, Lugar lugar, Throwable exeptionRaiz) {
		super(mensajeTecnico, exeptionRaiz);
		setMensajeUsuario(mensajeUsuario);
		setLugar(lugar);
	}
	
	public CrontollerPCHException(final String mensajeUsuario, final Lugar lugar) {
